...
lien_iframe <- function(etape){
  ...
  lien <- glue('<iframe src="https://ridewithgps.com/embeds?type=route&id={id_RWG}&metricUnits=true&sampleGraph=true" style="width: 1px; min-width: 100%; height: 700px; border: none;" scrolling="no" loading="lazy"></iframe>')
...
De 17:00 à 19:00, secteur Hôtel de Ville. 
...
- `r data$km_neutres[etape]` km neutralisés au départ   
- Arrivée au sommet du Mont Bell, Senneterre
- Remise des médailles à l'Hôtel de Ville
