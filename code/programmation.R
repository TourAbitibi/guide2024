...
dff <- tibble(
  ...
  epreuve =  glue('<strong>Route</strong><br/>{df$VilleDep[1]} - {df$VilleArr[1]} {df$Via[1]}<br/>Distance : {df$Descr_km[1]}<br/>({df$KM_Neutres[1]} km neutralisés au départ)'), 
...
dff <- tibble(
  ...
  epreuve =  glue('<strong>Contre-la-montre Individuel</strong><br/>{df$LieuDepFR[3]} <br/> {df$VilleArr[3]}<br/>Distance : {df$Descr_km[3]}'), 
...
dff <- tibble(
  ...
  epreuve =  glue('<strong>Circuit Urbain</strong><br/>{df$VilleDep[6]} &#8634; <br/>Distance : {df$Descr_km[6]}'), 
...
dfe <- tibble(
  ...
  presente  =  glue('<img src="../img/logo/comm_1.png" width="100">'),
  epreuve =  glue('<strong>Road race</strong><br/>{df$VilleDep[1]} - {df$VilleArr[1]} {df$Via[1]}<br/>Distance : {df$Descr_km[1]}<br/>({df$KM_Neutres[1]} km controlled start)'), 
...
dfe <- tibble(
  ...
  presente  =  glue('<img src="../img/logo/comm_3.png" width="100">'),
  epreuve =  glue('Individual Time Trial</strong><br/>{df$LieuDepEN[3]} <br/> {df$VilleArr[3]}<br/>Distance : {df$Descr_km[3]}'), 
...
dfe <- tibble(
  ...
  presente  =  glue('<img src="../img/logo/comm_6.png" width="100">'),
  epreuve =  glue('Urban Circuit</strong><br/>{df$VilleDep[6]} &#8634; <br/>Distance : {df$Descr_km[6]}'), 
