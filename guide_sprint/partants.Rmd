...
```{r is_liste_coureurs, include = FALSE, echo=FALSE}

# Lecture  de la liste de coureurs vers un .csv

if(file.exists(here("results", "Liste_Coureurs.csv"))){
...
```{r liste_coureurs, eval= STARTLIST_existe, include = FALSE, echo=FALSE}
